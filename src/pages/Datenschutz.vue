<template>
  <div class="datenschutz  q-px-lg q-pb-md">
    ...
    <p>
      E-Mail: hello@roundtrips4you.de</p>
    ...
    <p>Weitere Informationen zu Google Web Fonts finden Sie unter <a
      ...
      >https://developers.google.com/fonts/faq</a> und in der Datenschutzerkl&auml;rung von Google: <a
